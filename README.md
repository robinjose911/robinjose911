...
TypeScript, Next.js, Node.js, Python, PostgreSQL, Redis, BullMQ, Docker, Azure OpenAI, Gemini, LiveKit, ElevenLabs, LLM orchestration, AI evaluations, and production observability.
